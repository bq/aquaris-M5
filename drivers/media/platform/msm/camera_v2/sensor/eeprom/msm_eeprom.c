...
static int msm_eeprom_platform_probe(struct platform_device *pdev)
{
	...
	if((eb_info->eeprom_name != NULL) && ((strcmp(eb_info->eeprom_name,"truly_cmA016qr") == 0)||(strcmp(eb_info->eeprom_name,"imx214_olqba15") == 0)||(strcmp(eb_info->eeprom_name,"imx214_f13n05e") == 0)))
	{
		CDBG("imx214 name = %s\n",eb_info->eeprom_name);
