...
static int cyttsp5_btn_open(struct input_dev *input)
{
	...
	_cyttsp5_subscribe_attention(dev, CY_ATTEN_SUSPEND, CY_MODULE_BTN,
		cyttsp5_btn_suspend_attention, 0);

	/* set up resume call back */
	_cyttsp5_subscribe_attention(dev, CY_ATTEN_RESUME, CY_MODULE_BTN,
...
static void cyttsp5_btn_close(struct input_dev *input)
{
	...
	_cyttsp5_unsubscribe_attention(dev, CY_ATTEN_SUSPEND, CY_MODULE_BTN,
		cyttsp5_btn_suspend_attention, 0);

	_cyttsp5_unsubscribe_attention(dev, CY_ATTEN_RESUME, CY_MODULE_BTN,
		cyttsp5_btn_resume_attention, 0);
